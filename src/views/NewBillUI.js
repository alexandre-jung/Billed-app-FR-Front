            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="text" class="form-control blue-border" data-testid="expense-name" placeholder="Vol Paris Londres" name="name" />
                  </div>
                  <div class="col-half">
                  ...
                  <div class="col-half">
                    <div class="col-half-row">
                      <div class="flex-col">
                        ...
                        <input required type="number" class="form-control blue-border" data-testid="vat" placeholder="70" name="vat" />
                      </div>
                      <div class="flex-col">
